...
contract V4Router is AggregationV4BaseRouter {
    ...
    // TODO: minReturnAmount is the minimum allowed output amount, and can probably reduced to a max int of 500.
    //
    // the flags match specific constant masks. there is no documentation on these, and there seems to be no specific logic on them
